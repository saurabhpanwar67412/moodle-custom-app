...
import {LeaderboardPageModule} from '@addon/leaderboard/leaderboard.module';
import {PrizePageModule} from '@addon/prize/prize.module';
import {SalestoolsPageModule} from '@addon/salestools/salestools.module';
import {PrizehistoryPageModule} from '@addon/prizehistory/prizehistory.module';
import {RewardissuesPageModule} from '@addon/rewardissues/rewardissues.module';
import { CoreCourseSectionPageModule } from '@core/course/pages/section/section.module';
...
@NgModule({
    ...
    imports: [
        ...
        PrizePageModule,
        PrizePageModule,
        SalestoolsPageModule,
        PrizehistoryPageModule,
        RewardissuesPageModule,
